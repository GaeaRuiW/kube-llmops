...
# dependencies = []
# ///
"""RAG end-to-end load test — sends chat queries that exercise knowledge-base retrieval."""
...
PAYLOAD = json.dumps({
    "model": "default",
    "messages": [
        {"role": "system", "content": "Answer using the provided knowledge base context."},
        {"role": "user", "content": "What are the resource limits for the vLLM deployment?"},
    ],
    "max_tokens": 128,
}).encode()
...
def main() -> None:
    ap = argparse.ArgumentParser(description="RAG end-to-end load test")

...
# dependencies = []
# ///
"""Embedding endpoint load test — measures /v1/embeddings latency."""
...
DEFAULT_URL = "http://localhost:4000/v1/embeddings"
PAYLOAD = json.dumps({
    "model": "default",
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Embedding endpoint load test")
